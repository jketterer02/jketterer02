...
## <p align="center">💻 Projects 💻</p>
  ...
  * Student Success Center tutoring web application (React, JavaScript, CSS, MongoDB)
  * Student score prediction using machine learning and data mining (Python)
  * Android news application (Java & Android Studio, Firebase Auth)
  * Esports statistics database controlled via CLI (Python, MySQL)
  * Basic networking & routing (CISCO Packet Tracer)
  * Real-Time 3D physics simulation engine (C++)
